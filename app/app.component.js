System.register(['angular2/core', './courses.component', './authors.component', './star-icon.component', './heart-icon.component', './vote.component'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (star_icon_component_1_1) {
                star_icon_component_1 = star_icon_component_1_1;
            },
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent() {
                    this.post = { title: "Title", isActive: true };
                }
                AppComponent.prototype.onStarIconChange = function ($event) {
                    console.log($event);
                };
